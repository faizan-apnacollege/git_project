...
function Footer() {
    ...
    useEffect(() => {
        if (localStorage.getItem("token") != undefined) {
            ...
            setRole(!role)
            setFooterContent(<div class="container-fluid bg-dark text-light mt-5 py-5 wow fadeInUp" data-wow-delay="0.1s">
                <div class="container pt-5">
                    <div class="row g-5">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <p class="mb-2"><i class="bi bi-geo-alt text-primary me-2"></i>XYZ Street, Indore, INDIA</p>
